...
public class MainMenu
{
    ...
    public MainMenu() {}
        ...
        public static int accNumW;
        public bool continueBanking = false;

        public bool checkSecurity = true;
        public static int pChoice = 0;
    ...
    while(continueBanking)
        {
            ...
            //Console.WriteLine("No of Pass :"+ i);
            //Console.ReadLine();
            #region Case Options
                ...
                if ((choice! > 0) && (choice! < 7))
                {
                    switch (choice)
                    {
                        ...
                        case 3:
                            ...
                            WithdrawToAccount(pContinue);
                            // Console.WriteLine("continueBanking " +continueBanking);
                            // Console.WriteLine("pChoice " +pChoice);
                            // Console.WriteLine("Case " +checkSecurity);
                            // Console.ReadLine();      
                            break;
    ...
    public bool WithdrawToAccount(bool pOption3)
    {
        accMessage = "";
        string accDes = "Withdrawal";
        int cusPinW = Convert.ToInt32(pChoice);
        if((cusPinW > 0) && (checkSecurity))
        {
        accNumW = prjclslib.LoginAccount(accNoLogin);
        }
        if (accNumW != 0)
            {
            ...
            catch(Exception es)
            {
                ...
                Console.Write("Press enter and input the correct amount. ");
                Console.ReadLine();
                //Console.Clear();
                accMessage = "";
                pChoice = 0;
